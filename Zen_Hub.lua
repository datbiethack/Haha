...
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16656144525";
      Title = "nguyenthanhdat", 
      Text = "No Key For Now!!",
       Button1 = "Ok cool",
  })
...
LOGO.Image = "rbxassetid://16656144525"
...
wait(1)
LOADING.Text = "nguyenthanhdat"
BAR:TweenSize(UDim2.new(0, 150,0, 15), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
wait(1)
LOADING.Text = "Hello cu" ..game.Players.LocalPlayer.DisplayName.. " From: ".. code
...
loki.Image = "rbxassetid://16656144525"
