...
Main:Toggle("SuperFast Attack มีโอกาสโดนเตะออกจากเซิฟ ",_G.FastAttackNormalSpeed,function(value)
...
Main:Toggle("วาปไปหาเกียร์",function(value)
...
Dungeon:Toggle("Kill Aura เปิดตอนเข้าดัน ",_G.Kill,function(value)
	_G.Kill = value
end)
